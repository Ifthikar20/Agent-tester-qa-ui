...
<template>
  <!-- scrim, not ink: at night ink is light, and a light veil would lift the page instead of dimming it. -->
  <div class="fixed inset-0 z-30 flex justify-end bg-scrim/25" @click.self="emit('close')">
